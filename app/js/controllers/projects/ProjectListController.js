angular.module('AgaveToGo').controller('ProjectListController', function ($injector, $rootScope, $scope, $state, $stateParams, $q, $translate, SystemsController, RolesService, ActionsService, MessageService) {
