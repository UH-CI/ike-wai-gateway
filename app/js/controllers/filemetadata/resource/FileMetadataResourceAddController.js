angular.module('AgaveToGo').controller("FileMetadataResourceAddController", function($scope, $state, $stateParams, $translate, WizardHandler, MetaController, FilesController, MetadataService, ActionsService, MessageService) {
	$scope.model = {};
